...
Presentations are described by using PresentationML markup. For more information, see  [Working with PresentationML documents (Open XML SDK)](https://github.com/jhershey00/OpenXMLTest/blob/master/articles/56aeeed4-24ce-42ba-a236-6fec6785dd93.md). Presentation packages can contain the following document parts:
...
Spreadsheet workbooks are described by using SpreadsheetML markup. For more information, see  [Working with SpreadsheetML documents (Open XML SDK)](https://github.com/jhershey00/OpenXMLTest/blob/master/articles/c984c74e-2f06-4aba-a64b-2bb928b2929e.md). Workbook packages can contain:
...
You can find more information about these and other new features of the Open XML SDK 2.5 in the  [What's new in the Open XML SDK 2.5  for Office](https://github.com/jhershey00/OpenXMLTest/blob/master/articles/4fbda0e3-5676-4a8f-ba62-3fba59fa418b.md) article.
