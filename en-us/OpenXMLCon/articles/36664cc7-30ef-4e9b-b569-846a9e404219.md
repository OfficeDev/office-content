...
For more information about how to use the  **SharedStringTable** class to programmatically insert text into a cell, see [How to: Insert text into a cell in a spreadsheet document (Open XML SDK)](https://github.com/jhershey00/OpenXMLTest/blob/master/articles/5ded6212-e8d4-4206-9025-cb5991bd2f80.md).
