...
The following sections in this topic explain the implementation of this method and the supporting code, as well as how to call it. The complete sample code listing can be found in the  [Sample Code](8d465a77-6c1b-453a-8375-ecf80d2f1bdc.md) section at the end of this topic.
...
For more information about the overall structure of the parts and elements of a WordprocessingML document, see  [Structure of a WordprocessingML document (Open XML SDK)](03636fa2-be44-4e8d-9c26-7d38415bb459.md).
