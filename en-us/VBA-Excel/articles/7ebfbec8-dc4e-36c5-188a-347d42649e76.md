...
Returns a  ** [Range](b8207778-0dcc-4570-1234-f130532cc8cd.md)** object that represents the active cell in the active window (the window on top) or in the specified window. If the window isn't displaying a worksheet, this property fails. This is a Read-only property.
